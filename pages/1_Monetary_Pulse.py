...
def render() -> None:
    """Render the Monetary Pulse page.

    Friedman (1968 Nobel) — money supply drives long-run price levels;
    yield spread is the canonical leading indicator of monetary tightness.
    """
    ...
    fig_yield.update_layout(
        ...
        yaxis2=dict(title="Spread (bps)", overlaying="y", side="right",
